...
void Oathbreaker::ability1(Enemy* player, int cost){
...
void Oathbreaker::ability2(Enemy* player, int cost){
    if (does_it_hit(player) == true){
        player->take_damage(base_damage);
        this->set_stamina((stamina - cost));
...
void Oathbreaker::ability3(Enemy* opponent, int cost){
    this->AC = (AC + 4);
    this->speed = (speed - 2);
    this->set_stamina(stamina-cost);
...
void Oathbreaker::ability4(Enemy* player, int cost){
    this->AC = (AC - 2);
    this->speed = (speed - 2);
    this->set_stamina(stamina-cost);
